...
public class AlpacaApiClient 
{
    ...
    public LocalDate getPreviousWeekMonday() {
      
        LocalDate today = LocalDate.now(ZoneId.of("America/New_York"));
        return today.minusWeeks(0).with(DayOfWeek.MONDAY);
    }

public List<StockBar> fetchBarsForPreviousMonday(String symbol) {
    List<StockBar> bars = new ArrayList<>();
    try {
        LocalDate previousMonday = getPreviousWeekMonday();
        ZonedDateTime startNY = previousMonday.atTime(9, 30).atZone(ZoneId.of("America/New_York"));
        ZonedDateTime endNY = previousMonday.atTime(16, 0).atZone(ZoneId.of("America/New_York"));
        ...
        System.out.println("AlpacaApiClient::fetchBarsForPreviousMonday:169 Request URL: " + url);  // 👈 Add this to debug full request
