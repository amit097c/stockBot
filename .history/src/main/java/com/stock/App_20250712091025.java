      ...
      for(Volatility vol:vol_vals) 
        {
          ...
          std_dev_1_25=stdDevCal.compute_std_dev_1(previousClose,vol_val);
          std_dev_1_50=stdDevCal.compute_std_dev_1(previousClose,vol_val);
          std_dev_1_75=stdDevCal.compute_std_dev_1(previousClose,vol_val);
          std_dev_2=stdDevCal.compute_std_dev_2(previousClose,vol_val);
          std_dev_2_25=stdDevCal.compute_std_dev_1(previousClose,vol_val);
          std_dev_2_50=stdDevCal.compute_std_dev_1(previousClose,vol_val);
          std_dev_2_75=stdDevCal.compute_std_dev_1(previousClose,vol_val);
          ...
          for(int i=0;i<bars.size();i++) {
            ...
            if (close > previousClose&& currentHoldings > 0) {
