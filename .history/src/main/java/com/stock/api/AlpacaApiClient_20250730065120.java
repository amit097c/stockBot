...
public  String placeLimitSellForLong(String symbol, int qty, double limit_price) {
    try {
        limit_price = Math.round(limit_price * 100.0) / 100.0;
        ...
        order.put("limit_price", limit_price);       // actual sell price
        order.put("time_in_force", "day");
        order.put("client_order_id", order_id);// Add client order ID
