...
public String placeOcoSellToClose(String symbol, int qty, double takeProfitLimitSell, double stopLossSell,double longBuyEntryPrice)
 {
    try{
        ...
        {
            System.out.println("AlpacaApiClient::placeOcoSellToClose:1090 Stop loss buy and takeProfit limit is in range of long buy entry price. stopLossBuy: "+stopLossSell+" takeProfitLimitBuy: "+takeProfitLimitSell+" shortSellEntryPrice: "+shortSellEntryPrice);
