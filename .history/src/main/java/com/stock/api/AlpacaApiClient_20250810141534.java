    ...
    try{
        ...
        int responseCode = conn.getResponseCode();
        ...
        else 
         {
            ...
            System.out.println("AlpacaApiClient::placeShortEntry:1173 Failed to place long buy order. Response code: " + responseCode+ " for symbol: " + symbol+ "order_id: " + order_id);
            return ""; //
         } 
    }
   catch(Exception e) {
        System.err.println("Error placing short entry order: " + e.getMessage());
        e.printStackTrace();
    } 
 }
