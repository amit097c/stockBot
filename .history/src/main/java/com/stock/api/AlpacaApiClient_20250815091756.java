...
public String placeOcoSellToClose(String symbol, int qty, double takeProfitLimitSell, double stopLossSell,double longBuyEntryPrice)
 {
    try{
        ...
        {
            System.err.println("AlpacaApiClient::placeOcoSellToClose:1127: Stop loss buy or take profit limit buy is not in range of short sell entry price. stopLossBuy: "+stopLossSell+" takeProfitLimitBuy: "+takeProfitLimitSell+" shortSellEntryPrice: "+longBuyEntryPrice);
            return null;
        }
