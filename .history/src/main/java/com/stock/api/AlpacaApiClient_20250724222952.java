...
public double placeLongBuyBracketOrder(String symbol, int qty, double stopLossLevel, double takeProfitLevel) {
    try {
...
public int placeSellBracketOrder(String symbol, int qty, double stopLoss, double takeProfit) {
    try {
        URL url = new URL("https://paper-api.alpaca.markets/v2/orders");
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestMethod("POST");
