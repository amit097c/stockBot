    ...
    try{
        ...
        if(stopLossBuy>shortSellEntryPrice && takeProfitLimitBuy<shortSellEntryPrice)
        {
            ...
            do{
                 ...
                 System.out.println("AlpacaApiClient::placeOcoBuyToClose:1017 Checking open short qty for "+symbol+" open_qty: "+qty+" Thread: "+Thread.currentThread().getName()+" going to sleep for 1 second");
                 Thread.sleep(1000); // wait for 1 second before checking again
            }while(open_qty==0); 
            
            System.out.println("AlpacaApiClient::placeOcoBuyToClose:1017 Open short qty for "+symbol+" is: "+open_qty+" Thread: "+Thread.currentThread().getName());
