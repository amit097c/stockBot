...
// Helpers you likely have already:
private JSONObject getOrderByClientIdNested(String clientOrderId) throws IOException {
    String url = "https://paper-api.alpaca.markets/v2/orders:by_client_order_id?client_order_id="
            + java.net.URLEncoder.encode(clientOrderId, java.nio.charset.StandardCharsets.UTF_8);
    JSONObject o =  new JSONObject((url + "&nested=true"));
    if (!o.has("legs")) { // some environments need a second call
        String id = o.getString("id");
        o = new JSONObject(("https://paper-api.alpaca.markets/v2/orders/" + id + "?nested=true"));
    }
    return o;
}
