...
public  String placeStopBuy(String symbol, int qty, double stopPrice) {
    try {
        ...
        System.out.println("AlpacaApiClient:placeStopBuy:1152 Stop BUY (SL) order placed: " + stopPrice);
...
public  String placeStopSellForLong(String symbol, int qty, double stopPrice) {
    try {
        ...
        System.out.println("AlpacaApiClient:placeStopBuy:1237 Stop Sell Long order placed: " + stopPrice);
        return order_id; // Return the client order ID for tracking
    } catch (Exception e) {
        System.err.println("Error placing stop buy: " + e.getMessage());
        e.printStackTrace();        
...
public  String placeLimitSellForLong(String symbol, int qty, double limitPrice) {
    try {
        ...
        System.out.println("AlpacaApiClient:placeStopBuy:1237 Stop Sell Long order placed: " + limitPrice);
        return order_id; // Return the client order ID for tracking
    } catch (Exception e) {
        System.err.println("Error placing stop buy: " + e.getMessage());
        e.printStackTrace();        
...
public boolean cancelOrderByClientId(String clientOrderId) {
    try {
        ...
        String getUrl = "https://paper-api.alpaca.markets/v2/orders:by_client_order_id?client_order_id=" + URLEncoder.encode(clientOrderId, "UTF-8");
        ...
        if (getRespCode != 200) {
            System.err.println("❌ Failed to fetch order by client_order_id: " + clientOrderId);
        ...
        if (deleteRespCode == 204) {
            System.out.println("✅ Order canceled successfully by client_order_id: " + clientOrderId);
            return true;
        } else {
...
public String placeLimitBuy(String symbol, int qty, double limitPrice) {
    try {
        ...
        System.out.println("AlpacaApiClient:placeStopBuy:1184 Limit BUY (TP) order placed: " + limitPrice);
        return order_id; // Return the client order ID for tracking
    } catch (Exception e) {
